...
class ProcessTraces:
    ...
    def print_stats(self, lines):
        ...
        with open(sdm_trace_dir, 'r', encoding='utf8', errors='ignore' ) as f:
            ...
            for i in data:
                i = i.strip()
                if(len(i) > 0 and i[0].isupper() and i.__contains__('_')):
                    print(i)
            """
            ...
            for i, t in enumerate(data):
                ...
                if len(t) > 0 and t[0].isupper() and t.__contains__('_'):
...
def searching_db():
    ...
    if stdout_df.empty != True:
        ...
        print("Hey, No ERRORed traces found!! :)")
    ...
    if (len(sys.argv) < 2):
        ...
        if os.path.exists(fn):
            ...
            if (choice == 'Y'):
                ...
                txt_file_names = processTraces.find_files(filename)
